...
<body>
	...
	<h1 style="color: black; font-size: 40px;" align="center">THIS IS next version to your project</h1>	
	<h1 style="color: green; font-size: 40px;" align="center">THIS IS last version to our project</h1>
